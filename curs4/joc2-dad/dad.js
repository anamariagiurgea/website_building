...
function handleCardDrop(event, ui) {
    ...
    if (slotNumber === cardNumber) {
        ...
        if (slotNumber == 3) {
            $('#message').show().html(' JavaScript este un limbaj de programare de nivel înalt, utilizat pentru dezvoltarea paginilor web interactive. Este un limbaj interpretat, dinamic, bazat pe prototipuri si orientat pe evenimente.<br> <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/9/99/Unofficial_JavaScript_logo_2.svg/140px-Unofficial_JavaScript_logo_2.svg.png" style="max-width:100px">');
        }
    }
